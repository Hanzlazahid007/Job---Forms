...
const Sidebar3 = ({ flag }) => {
  return (
    <div>
      <div className="xl:h-[157vh] xl:w-1/4 w-[100%] p-4 xl:p-0  bg-[#2668E8] ">
        <div className="xl:pl-5 xl:pt-5">
          <div className="flex flex-col  ">
            ...
            <div className="flex xl:block mt-2 xl:mt-0  ">
              <div className="xl:flex xl:mt-6 hidden  ">
              ...
              <div className="xl:flex   xl:mt-6">
                ...
                <div className="xl:ml-3 xl:-mt-1">
                  <h1 className="text-white  xl:ml-0 text-sm">
                    Company Profile
                  </h1>
                  <p className="text-white hidden xl:block text-sm">
                    Lorem ipsum dolor sit amet.
              ...
              <div className="xl:ml-11 ml-6 xl:mt-2 -mb-2 text-white">
                <h1>Job Post</h1>
              </div>
              ;
            </div>
